...
def main():
    ...
    sigma = st.sidebar.number_input("Standard Deviation (SD)",value=13.0,min_value=0.01,help= "Enter a value >0")
    ...
    if(x== "Given"):
        ...
        ICC= st.sidebar.number_input("Intra-class Correlation (ICC) for clustering",min_value=0.0,help="Enter a decimal value (e.g., 0.05)")
